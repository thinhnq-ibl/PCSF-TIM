"""
Scan workspace and meta_prior/ for newly added Meta MDM files and date ranges.
"""
...
def check_new_meta():
    print("="*75)
    print("       CHECKING FOR NEW META MDM FILES & DATES IN WORKSPACE")
    print("="*75)
    
    meta_files = list(ROOT_DIR.glob("**/*movement*.csv")) + list(ROOT_DIR.glob("**/meta_prior/*.csv"))
