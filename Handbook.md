...
| **Scientific Question** | **Why have aggregate Trip-Length Distributions been used primarily for model evaluation rather than behavioural parameter inference, and what is the methodological research gap?** | **Tại sao Phân bố Độ dài Chuyến đi (TLD) tổng hợp trong các nghiên cứu hiện nay chủ yếu được sử dụng để đánh giá mô hình, thay vì để suy luận tham số hành vi, và khoảng trống nghiên cứu phương pháp luận là gì?** |
