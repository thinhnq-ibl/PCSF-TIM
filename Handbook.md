...
| Claim ID | Scientific Claim | Representative References | How the References Support the Claim | Handbook Contribution |
| -------- | ---------------- | ------------------------- | ------------------------------------ | --------------------- |
| **E1** | Mobility can be observed at multiple levels of aggregation. | Barbosa et al. (2018); González et al. (2008) | Human mobility is observed through trajectories, OD matrices, aggregated statistics and other observation forms. | None (Established knowledge). |
| **E2** | Different observation levels preserve different information about spatial interaction. | Barbosa et al. (2018); mobility observation literature | Different observation forms retain different spatial, temporal and relational information. | None (Established synthesis). |
| **E3** | Aggregation transforms observations by preserving some information while discarding other information. | Casella & Berger (2002); aggregation literature | Aggregation changes the observable information available for subsequent analysis. | None (General statistical principle). |
| **E4** | Mobility observations can be organized according to the information they preserve rather than according to their sensing technologies. | Barbosa et al. (2018) | Existing reviews classify observations by data source (GPS, CDR, surveys, smart cards), whereas the preserved-information perspective provides an alternative organizational principle. | **Primary conceptual contribution of the Handbook.** |
| **E5** | Information preservation depends on the observation itself rather than on the technology used to collect it. | Built upon E1–E4. | The same sensing technology may support multiple observation forms, while similar observation forms may arise from different sensing technologies. | **Handbook synthesis.** |
| **E6** | Information preservation provides a common language for comparing heterogeneous mobility observations. | Built upon E4–E5. | Organizing observations by preserved information enables direct comparison across otherwise heterogeneous datasets. | **Handbook framework.** |
| **E7** | Viewing aggregation through the lens of information preservation naturally raises the question of whether the remaining information is sufficient for parameter estimation. | Built upon Modules C–E. | Once observations are organized by preserved information, the next scientific question becomes whether the preserved information remains sufficient for estimating explicitly parameterized distance-response models. | **Bridge to Module F.** |
