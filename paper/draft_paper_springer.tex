...
\begin{figure*}[t!]
  ...
  \caption{Conceptual comparison between conventional survey-based mobility modeling and the proposed Projection--Inference Gravity Framework (PIGF). Instead of requiring observed OD matrices to calibrate spatial friction, PIGF reformulates mobility prediction as a behavioral inference problem, recovering distance-decay functions directly from privacy-preserving aggregate trip-length distributions.}
