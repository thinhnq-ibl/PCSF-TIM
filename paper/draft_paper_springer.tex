...
Table~\ref{tab:literature_comparison} compares how existing model classes address the core challenge of zero-shot cross-city transfer. The comparison reveals a central unresolved question: whether the most important component of spatial interaction can be recovered from aggregate mobility data. Concretely, existing work lacks (i) a practical aggregate-based recovery method for city-specific distance decay, and (ii) a quantitative decomposition showing how much predictive performance depends on this component. In addition, we explore whether urban morphology may influence the effectiveness of aggregate calibration. These gaps and exploratory questions map directly to the research questions evaluated throughout this study.
